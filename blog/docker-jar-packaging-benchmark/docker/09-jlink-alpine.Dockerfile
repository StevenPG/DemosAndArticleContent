...
# Variant 09 - jlink runtime built against musl, shipped on Alpine.
# The smallest thing here that still runs a normal JVM. Everything is
# built in the Alpine JDK image so the runtime links against musl.
