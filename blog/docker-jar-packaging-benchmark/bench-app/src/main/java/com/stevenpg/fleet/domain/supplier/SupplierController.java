...
public class SupplierController {
    ...
    public PageResponse<SupplierDto> byStatus(
    ...
    public List<SupplierSummary> summaries(@RequestParam(defaultValue = "20") int size) {
    ...
    @GetMapping("/{id}")
    public SupplierDto byId(@PathVariable Long id) {
        return service.byId(id);
    }

    @GetMapping("/code/{code}")
    public SupplierDto byCode(@PathVariable String code) {
