...
public class PartController {
    ...
    public PageResponse<PartDto> byStatus(
    ...
    public List<PartSummary> summaries(@RequestParam(defaultValue = "20") int size) {
    ...
    @GetMapping("/{id}")
    public PartDto byId(@PathVariable Long id) {
        return service.byId(id);
    }

    @GetMapping("/code/{code}")
    public PartDto byCode(@PathVariable String code) {
