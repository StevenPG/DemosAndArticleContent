...
public class FlightPlan {
    ...
    private FlightPlanStatus status = FlightPlanStatus.ACTIVE;
    ...
    @Size(max = 64)
    @Column(name = "callsign", length = 64)
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof FlightPlan that)) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        return FlightPlan.class.hashCode();
    }
}
