...
public class AlertController {
    ...
    public PageResponse<AlertDto> byStatus(
    ...
    public List<AlertSummary> summaries(@RequestParam(defaultValue = "20") int size) {
    ...
    public AlertDto byCode(@PathVariable String code) {
    ...
    @PutMapping("/{id}")
    public AlertDto update(@PathVariable Long id, @Valid @RequestBody AlertDto dto) {
