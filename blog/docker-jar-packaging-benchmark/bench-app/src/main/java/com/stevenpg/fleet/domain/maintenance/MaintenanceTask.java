...
public class MaintenanceTask {
    ...
    private MaintenanceTaskStatus status = MaintenanceTaskStatus.ACTIVE;
    ...
    @Size(max = 64)
    @Column(name = "manual_ref", length = 64)
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MaintenanceTask that)) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        return MaintenanceTask.class.hashCode();
    }
}
