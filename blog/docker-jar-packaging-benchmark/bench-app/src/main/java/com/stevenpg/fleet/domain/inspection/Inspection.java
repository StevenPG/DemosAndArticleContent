...
public class Inspection {
    ...
    private InspectionStatus status = InspectionStatus.ACTIVE;
    ...
    @Size(max = 64)
    @Column(name = "checklist_ref", length = 64)
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Inspection that)) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        return Inspection.class.hashCode();
    }
}
