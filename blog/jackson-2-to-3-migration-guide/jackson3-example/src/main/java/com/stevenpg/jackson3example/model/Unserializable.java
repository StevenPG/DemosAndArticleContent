 ...
 *
 * <p><b>Migration footnote:</b> this project originally used an EMPTY class
 * (no fields at all) for this demo, since Jackson 2's
 * {@code FAIL_ON_EMPTY_BEANS} throws for that case by default. That default
 * changed in Jackson 3 - serializing a type with zero properties now
