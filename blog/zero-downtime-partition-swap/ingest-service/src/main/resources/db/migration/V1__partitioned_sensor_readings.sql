...
CREATE TABLE sensor_readings (
    -- UUIDv7, generated by the producer: time-ordered, so the primary key is
    -- physically correlated with the heap instead of scattering across every
    -- leaf page the way random v4 keys do.
    id          uuid             NOT NULL,
